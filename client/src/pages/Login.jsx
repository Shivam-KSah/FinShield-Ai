      ...
      <div className="auth-container">
        ...
        <div className="auth-left">
          ...
          <p className="auth-tagline">
            AI-powered transaction risk scoring, anomaly detection, and compliance workflow for modern financial institutions.
          </p>
          <div className="auth-features">
            {['Risk Scoring Engine', 'Gemini AI Investigator', 'Role-Based Compliance', 'Real-time Audit Logs'].map(f => (
          ...
          <div className="auth-badges">
            <span className="auth-badge">BNY Mellon Ready</span>
            <span className="auth-badge">NatWest Grade</span>
            <span className="auth-badge">Fidelity Compliant</span>
          </div>
        </div>
        ...
        <div className="auth-right">
          <div className="auth-card">
            ...
            <div className="demo-btns">
              ...
              {['customer', 'officer', 'admin'].map(r => (
                <button key={r} className="demo-btn" onClick={() => fillDemo(r)} type="button">
                  {r}
                </button>
              ))}
            </div>
